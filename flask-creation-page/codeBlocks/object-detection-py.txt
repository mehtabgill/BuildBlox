...
'''
def startModule(img, info):
    
    print(info["Analytic Result"][0])  # 4
    ...
    print(resp.content)
    return info["Analytic Result"][0]
'''


def startModule(img):
    info = analyze_img(img_file="ppl2.jpg", analytic="faces")
    img = "ppl2.jpg"
...
# print(analyze_img(img_file="ppl2.jpg", analytic="faces"))
#output = startModule(img="ppl2.jpg", info=analyze_img(img_file="ppl2.jpg", analytic="faces"))
